diff --git a/core-services/egov-url-shortening-go/utils/hashid.go b/core-services/egov-url-shortening-go/utils/hashid.go
--- a/core-services/egov-url-shortening-go/utils/hashid.go
+++ b/core-services/egov-url-shortening-go/utils/hashid.go
@@ -0,0 +1,166 @@
+package utils
+
+import (
