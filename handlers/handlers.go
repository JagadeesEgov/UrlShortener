diff --git a/core-services/egov-url-shortening-go/handlers/handlers.go b/core-services/egov-url-shortening-go/handlers/handlers.go
--- a/core-services/egov-url-shortening-go/handlers/handlers.go
+++ b/core-services/egov-url-shortening-go/handlers/handlers.go
@@ -0,0 +1,369 @@
+package handlers
+
+import (
