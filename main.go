diff --git a/core-services/egov-url-shortening-go/main.go b/core-services/egov-url-shortening-go/main.go
--- a/core-services/egov-url-shortening-go/main.go
+++ b/core-services/egov-url-shortening-go/main.go
@@ -0,0 +1,163 @@
+package main
+
+import (
