diff --git a/core-services/egov-url-shortening-go/repository/postgres.go b/core-services/egov-url-shortening-go/repository/postgres.go
--- a/core-services/egov-url-shortening-go/repository/postgres.go
+++ b/core-services/egov-url-shortening-go/repository/postgres.go
@@ -0,0 +1,313 @@
+package repository
+
+import (
