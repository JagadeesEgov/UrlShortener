diff --git a/core-services/egov-url-shortening-go/repository/interface.go b/core-services/egov-url-shortening-go/repository/interface.go
--- a/core-services/egov-url-shortening-go/repository/interface.go
+++ b/core-services/egov-url-shortening-go/repository/interface.go
@@ -0,0 +1,49 @@
+package repository
+
+import (
